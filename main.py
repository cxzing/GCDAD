...
if __name__ == '__main__':
    ...
    parser.add_argument('--patch_size', type=list, default=[3])
    parser.add_argument('--space_num', type=list, default=[3])
    ...
    parser.add_argument('--input_c', type=int, default=25)##########MSL 55
